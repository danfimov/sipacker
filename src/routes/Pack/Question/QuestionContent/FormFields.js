...
import {
  ...
  questionTypesHint,
  realPriceHint,
  realPriceStepperHint,
  realThemeHint,
  bagcatRealPriceTypeHint,
} from './hints'
    ...
    <>
      ...
      {formik.values.type === 'cat' && (
        <>
          <WithHint hint={realPriceHint}>
            <FormikTextField
              name='realprice'
              label='Настоящая стоимость вопроса'
              {...numberFieldProps}
            />
          </WithHint>
      ...
      {formik.values.type === 'bagcat' && (
        <>
          ...
          {formik.values.questionPriceType === 'fixed' && (
            <WithHint hint={realPriceHint}>
              <FormikTextField
                name='realprice'
                label='Настоящая стоимость вопроса'
          ...
          {formik.values.questionPriceType === 'byPlayer' && (
            <WithHint hint={realPriceStepperHint}>
      ...
      {formik.values.type === 'bagcat' && (
        <>
          ...
          <WithHint
            hint={
              <p>
                Если выбран вариант <b>Никогда</b>, то вопрос не задаётся, игроку просто
                перечисляется его стоимость
              </p>
            }
          >
            <FormikSelect
